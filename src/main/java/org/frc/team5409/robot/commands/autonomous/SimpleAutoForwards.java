...
public class SimpleAutoForwards extends SequentialCommandGroup {
     ...
     */
    public SimpleAutoForwards(ShooterFlywheel sys_flywheel, ShooterTurret sys_rotation, Limelight sys_limelight,
