 ...
 */
public class ExtendHangLow extends CommandBase {
  /**
   * Creates a new ExtendNeo.
   */
  private final Hanging m_hanging;

  public ExtendHangLow(Hanging subsystem) {
  ...
  public boolean isFinished() {
    ...
    // finished = true;
    // }
    return m_hanging.getEncoderAvgPosition() > Constants.Hanging.EXTEND_NEO_POS_MIN;
    //return false;
  }
}
